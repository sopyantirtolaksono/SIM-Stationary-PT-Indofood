<?php
  ...
  // ambil id admin pada session admin yg login
  $idAdmin   = $_SESSION["admin"]["id_admin"];

  // ambil data admin
  $sqlAdmin 	= "SELECT * FROM tbl_admin WHERE id_admin = '$idAdmin' ";
  $ambilAkun    = $conn->query($sqlAdmin);
          ...
          <div class="card-body box-profile">
            <div class="text-center">
              <img class="profile-user-img img-fluid img-circle"
                   src="src/dist/img/img_admin/<?=$pecahAkun['gambar']; ?>"
                   alt="Foto member">
            </div>
          ...
          <div class="card-body">
            <div class="tab-content">
              ...
              <div class="tab-pane active" id="settingsAkun">
                <form action="src/components/ajax/set_akun_admin.php" method="post" class="form-horizontal" id="formSettingsAkun" enctype="multipart/form-data">
              ...
              <div class="tab-pane " id="settingsPassword">
                <form action="src/components/ajax/set_pass_admin.php" method="post" class="form-horizontal" id="formsettingsPassword">
...
<!-- JS File -->
<!-- Profil Admin -->
<script src="src/dist/js/ajax/profil_admin.js"></script>